...
def read_yaml(path_to_yaml: Path) -> ConfigBox:
    """ reads yaml file and returns
        ...
        Raises : ValueError- if yaml file is empty, e-empty file
    ...
    try:
        ...
        raise ValueError(f"Error in YAML file {path_to_yaml}: {e}")
    except Exception as e :
        logger.error(f"An error occured while reading the YAML file {path_to_yaml}: {e}")
        raise e
